...
*/
	...
	return array(
		...
		'a_followed_body' => "پاسخ شما در ^site_title دارای یک سوال مشابه جدید است ^q_handle:\n\n^open^q_title^close\n\nپاسخ شما :\n\n^open^a_content^close\n\nبرای پاسخ به این سوال جدید بر روی لینک زیر کلیک نمایید\n\n^url\n\nبا تشکر,\n\n^site_title",
		'a_followed_subject' => 'پاسخ شما در ^site_title دارای یک سوال مشابه است',
		...
		'q_answered_subject' => 'سوال شما در ^site_title دارای پاسخ جدیدی است',
		...
		'q_commented_subject' => 'سوال شما در ^site_title دارای دیدگاه جدیدی است',

		'q_posted_body' => "یک سوال جدید توسط کاربر : ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nپرسیده شده است - برای نمایش سوال بر روی لینک مقابل کلیک کنید :\n\n^url\n\nبا تشکر,\n\n^site_title",
		'q_posted_subject' => '^site_title دارای سوال جدیدی است',
